...
function generate_multisite_sales_report_html($report, $total_all_sites, $total_revenue_all, $total_orders_all)
{
...
function send_email_product_qty_statics()
{
    ...
    foreach ($sites as $site) {
        ...
        $data = product_qty_sta_for_each_site();
    ...
    $body = generate_multisite_sales_report_html($report, $total_all_sites, $total_revenue_all, $total_orders_all);
    $header = array('Content-Type: text/html; charset=UTF-8');

    wp_mail($to, $subject, $body, $header);
}

add_action('send_daily_product_qty_email', 'send_email_product_qty_statics');
